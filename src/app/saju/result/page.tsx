  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center p-4 pt-20 pb-32">
      ...
      <div className="w-full max-w-4xl mx-auto z-10">
        ...
        <CaptureWrapper filename="mystic-saju">
          <div className="bg-slate-900/60 backdrop-blur-xl border border-emerald-500/30 rounded-3xl p-6 md:p-10 shadow-2xl relative overflow-hidden">
