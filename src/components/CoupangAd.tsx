...
export default function CoupangAd({ type, compact = false }: CoupangAdProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] text-slate-500 text-center mt-3 tracking-tight">
        {language === "ko" 
          ? '"이 포스팅은 쿠팡 파트너스 활동의 일환으로, 이에 따른 일정액의 수수료를 제공받습니다."'
          : '"This post is part of Coupang Partners activities, and a certain amount of commission is provided accordingly."'}
      </p>
    </motion.div>
  );
}
